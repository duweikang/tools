...
//		this.element = $(element);
		if(options.singleDatePicker) {
			...
			var DRPTemplate = '<div class="daterangepicker dropdown-menu" style="padding-left:100px">' +
				'<div class="timeBoxLeft">' +
				'<div class="timeChooseItem" onclick="getLastSomeDays(1)">昨天</div>' +
				'<div class="timeChooseItem" onclick="getToday()">今天</div>' +
				'<div class="timeChooseItem" onclick="getCurrentMath()">本月</div>' +
				'<div class="timeChooseItem" onclick="getLastSomeDays(7)">最近7天</div>' +
				'<div class="timeChooseItem" onclick="getLastSomeDays(30)">最近30天</div>' +
				'<div class="timeChooseItem" onclick="getCurrentWeek()">最近一周</div>' +
				'<div class="timeChooseItem" onclick="getLastSomeMathes(1)">最近一月</div>' +
				'<div class="timeChooseItem" onclick="getLastSomeMathes(2)">最近二月</div>' +
				'<div class="timeChooseItem" onclick="getLastSomeMathes(3)">最近三月</div>' +
				'</div>' +
				'<div class="timeBoxRight">' +
		...
		this.container.find('.calendar')
			...
			.on('change.daterangepicker', 'select.hourselect,select.minuteselect,select.secondselect', $.proxy(this.updateTime, this));
	...
	DateRangePicker.prototype = {
		...
		updateInputText: function() {
			if(this.element.is('input') && !this.singleDatePicker) {
				...
				$(".startTime").val(this.startDate.format(this.format));
				$(".endTime").val(this.endDate.format(this.format));
		...
		updateCalendars: function() {
			...
			this.rightCalendar.calendar = this.buildCalendar(this.rightCalendar.month.month(), this.rightCalendar.month.year(), this.rightCalendar.month.hour(), this.rightCalendar.month.minute(), this.leftCalendar.month.second(), 'right');
